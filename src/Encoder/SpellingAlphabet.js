...
const alphabetSpecs = [
  ...
  },
  {
    ...
    words: [
      ...
      'Елена',        'Ёлка',       'Женя',         'Зинаида',    'Иван',
      'Иван_краткий', 'Константин', 'Леонид',       'Михаил',     'Николай',
      'Ольга',        'Павел',      'Роман',        'Семён',      'Татьяна',
      'Ульяна',       'Фёдор',      'Харитон',      'Цапля',      'Человек',
      'Шура',         'Щука',       'Твёрдый_знак', 'Еры',        'Мягкий_знак',
      'Эхо',          'Юрий',       'Яков',         'Ноль',       'Один',
